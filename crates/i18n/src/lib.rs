...
impl I18n {
    ...
    pub fn t(&self, key: MessageKey) -> &'static str {
        match (self.locale, key) {
            ...
            (Locale::ZhHans, MessageKey::SceneOptionOn) => "开",
            (_, MessageKey::SceneOptionOn) => "On",
            (Locale::ZhHans, MessageKey::SceneOptionOff) => "关",
            (_, MessageKey::SceneOptionOff) => "Off",
...
pub struct UiBundle {
    ...
    pub scene_option_on: String,
    pub scene_option_off: String,
...
impl UiBundle {
    pub fn from_prefs(
        ...
        Self {
            ...
            settings_shortcuts: s.settings_shortcuts,
            shortcuts_category_general: s.shortcuts_category_general,
            shortcuts_category_viewer: s.shortcuts_category_viewer,
            shortcuts_press_keys: s.shortcuts_press_keys,
            shortcuts_reset_all: s.shortcuts_reset_all,
            shortcuts_restore: s.shortcuts_restore,
            shortcuts_conflict: s.shortcuts_conflict,
            shortcuts_double_click_fit: s.shortcuts_double_click_fit,
            theme_dark: s.theme_dark,
            theme_light: s.theme_light,
            theme_system: s.theme_system,
            settings_viewer_scene: s.settings_viewer_scene,
            scene_preview_grid: s.scene_preview_grid,
            scene_guides: s.scene_guides,
            scene_option_on: s.scene_option_on,
            scene_option_off: s.scene_option_off,
            tool_preview_grid: s.tool_preview_grid,
            tool_scene_guides: s.tool_scene_guides,
        }
    }
...
impl UiStrings {
    pub fn from_i18n(i18n: &I18n) -> Self {
        ...
        Self {
            ...
            settings_shortcuts: s(MessageKey::SettingsShortcuts),
            shortcuts_category_general: s(MessageKey::ShortcutsCategoryGeneral),
            shortcuts_category_viewer: s(MessageKey::ShortcutsCategoryViewer),
            shortcuts_press_keys: s(MessageKey::ShortcutsPressKeys),
            shortcuts_reset_all: s(MessageKey::ShortcutsResetAll),
            shortcuts_restore: s(MessageKey::ShortcutsRestore),
            shortcuts_conflict: s(MessageKey::ShortcutsConflict),
            shortcuts_double_click_fit: s(MessageKey::ShortcutsDoubleClickFit),
            theme_dark: s(MessageKey::ThemeDark),
            theme_light: s(MessageKey::ThemeLight),
            theme_system: s(MessageKey::ThemeSystem),
            settings_viewer_scene: s(MessageKey::SettingsViewerScene),
            scene_preview_grid: s(MessageKey::ScenePreviewGrid),
            scene_guides: s(MessageKey::SceneGuides),
            scene_option_on: s(MessageKey::SceneOptionOn),
            scene_option_off: s(MessageKey::SceneOptionOff),
            tool_preview_grid: s(MessageKey::ToolPreviewGrid),
            tool_scene_guides: s(MessageKey::ToolSceneGuides),
        }
    }
}
